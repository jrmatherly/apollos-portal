      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-text-secondary mt-1">
            Manage cross-functional units and their LLM resource allocations.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-surface border border-surface-border rounded-xl p-6 flex flex-col group hover:border-primary transition-all duration-300">
          ...
          <div className="mb-6 flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="px-2 py-1 rounded bg-surface-border/30 text-[10px] font-medium text-text-primary">
                GPT-4o
              </span>
              <span className="px-2 py-1 rounded bg-surface-border/30 text-[10px] font-medium text-text-primary">
                Claude 3.5 Sonnet
          ...
          <div className="pt-4 border-t border-surface-border flex gap-2">
            <button className="flex-1 py-2 rounded-lg bg-surface-border/30 hover:bg-surface-border/50 text-text-primary text-xs font-bold transition-colors">
              Manage
            </button>
            <button className="flex-1 py-2 rounded-lg bg-primary/10 text-primary hover:bg-primary hover:text-white text-xs font-bold transition-all">
              Analytics
            </button>
          </div>
        </div>
        ...
        <div className="border-2 border-dashed border-surface-border rounded-xl p-6 flex flex-col items-center justify-center gap-4 text-text-secondary hover:text-primary hover:border-primary transition-all cursor-pointer group">
          ...
          <div className="text-center">
            <p className="font-bold text-sm text-text-primary group-hover:text-primary">
              Create New Team
            </p>
