  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full space-y-8">
      ...
      <div className="flex flex-wrap items-end gap-4">
        <div
          className="flex flex-col gap-1.5 relative min-w-[240px]"
            ...
            {isModelDropdownOpen && (
              ...
              >
                ...
                {availableModels.map((model) => (
                  <label
                    key={model}
                    className="flex items-center px-3 py-2.5 hover:bg-surface-border/10 cursor-pointer gap-3 group"
                  >
                    <div
                      className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${selectedModels.includes(model) ? "bg-primary border-primary text-white" : "border-surface-border group-hover:border-primary/50"}`}
                    >
            ...
            {isKeyDropdownOpen && (
              ...
              >
                ...
                {availableKeys.map((key) => (
                  ...
                  >
                    <div
                      className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${selectedKeys.includes(key) ? "bg-primary border-primary text-white" : "border-surface-border group-hover:border-primary/50"}`}
                    >
            ...
            <button
              ...
              className={`relative px-5 py-2 text-xs font-bold rounded-md transition-all ${
                activeMetric === metric
                  ...
                  : "text-text-secondary hover:text-text-primary hover:bg-surface-border/10"
              }`}
            >
              {activeMetric === metric && (
                <motion.div
          ...
          <table className="w-full text-left">
            <thead className="bg-surface-border/10 border-b border-surface-border">
              <tr>
                ...
                <th
                  className="px-6 py-4 text-[10px] font-bold text-text-secondary uppercase tracking-widest text-right group/th cursor-help"
                  title="Total number of tokens sent in requests"
                >
                ...
                <th
                  className="px-6 py-4 text-[10px] font-bold text-text-secondary uppercase tracking-widest text-right group/th cursor-help"
                  title="Total number of tokens generated in responses"
                >
                  <div className="flex items-center justify-end gap-1">
                    Output Tokens
                    <Info className="w-3 h-3 opacity-50 group-hover/th:opacity-100 transition-opacity" />
                ...
                <th
                  className="px-6 py-4 text-[10px] font-bold text-text-secondary uppercase tracking-widest text-right group/th cursor-help"
                  title="Total cost incurred for this model"
                >
                  <div className="flex items-center justify-end gap-1">
                    Total Cost
                    <Info className="w-3 h-3 opacity-50 group-hover/th:opacity-100 transition-opacity" />
                ...
                [...Array(3)].map((_, i) => (
                  <tr key={i}>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-24"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-20 ml-auto"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-20 ml-auto"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-16 ml-auto"></div>
                    </td>
                  </tr>
                ))
              ) : (
        ...
        <div className="bg-surface border border-surface-border p-6 rounded-xl hover:border-surface-border/80 transition-colors group/card relative">
          <div className="flex items-center justify-between mb-1">
            ...
            <div
              ...
              title="Calculated by dividing Total Cost by the Total Number of Requests in the selected period."
            >
        ...
        <div className="p-6 border-b border-surface-border flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input
                className="bg-bg-primary border border-surface-border rounded-md text-xs pl-9 py-2 w-64 focus:ring-primary focus:border-primary outline-none text-text-primary"
            ...
            <tbody className="divide-y divide-surface-border">
              {isLogLoading ? (
                [...Array(4)].map((_, i) => (
                  <tr key={i}>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-32"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-24"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-16"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-4 bg-surface-border/20 rounded animate-pulse w-16"></div>
                    </td>
