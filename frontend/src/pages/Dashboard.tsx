      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-surface border border-surface-border rounded-lg p-5">
          <div className="flex justify-between items-start mb-4">
            ...
            <select
              defaultValue="30D"
              className="bg-surface border border-surface-border rounded text-[10px] font-bold text-text-secondary uppercase tracking-widest py-1 px-2 focus:ring-0 cursor-pointer"
            >
        ...
        <div className="bg-surface border border-surface-border rounded-lg p-5">
          ...
          <div className="mt-1">
            ...
            <p className="text-xs text-text-secondary">
              Key:{" "}
              <span className="font-mono text-text-primary">prod-main-v2</span>
            </p>
          </div>
        </div>
      </div>
