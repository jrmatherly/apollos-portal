    ...
    <div className="p-8 max-w-7xl mx-auto w-full space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div className="space-y-2">
          ...
          <p className="text-text-secondary max-w-2xl text-lg">
            Enterprise-grade model registry and technical specifications for
      ...
      <div className="flex flex-wrap gap-3 items-center mb-8">
        ...
        <div className="flex gap-2">
          <span className="px-4 py-2 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs font-bold uppercase tracking-wider cursor-pointer">
            All Providers
          </span>
          <span className="px-4 py-2 rounded-full bg-surface border border-surface-border text-text-secondary text-xs font-bold uppercase tracking-wider cursor-pointer hover:border-primary/50 hover:text-text-primary transition-colors">
            OpenAI
          </span>
          <span className="px-4 py-2 rounded-full bg-surface border border-surface-border text-text-secondary text-xs font-bold uppercase tracking-wider cursor-pointer hover:border-primary/50 hover:text-text-primary transition-colors">
            Anthropic
        ...
        <div className="bg-surface border border-surface-border rounded-xl overflow-hidden flex flex-col hover:border-primary/40 transition-all group">
          <div className="p-6 flex-1">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="bg-surface-border/50 text-text-primary text-[10px] px-2 py-1 rounded font-bold uppercase tracking-tighter border border-surface-border">
                OpenAI
              </span>
            </div>
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="bg-secondary/10 text-secondary text-[10px] px-2 py-0.5 rounded-full font-bold border border-secondary/20">
                VISION
              </span>
              <span className="bg-warning/10 text-warning text-[10px] px-2 py-0.5 rounded-full font-bold border border-warning/20">
                AUDIO
              </span>
            </div>
          ...
          <div className="bg-surface-border/10 p-4 border-t border-surface-border flex gap-2">
            <button className="flex-1 bg-primary py-2 rounded-md text-xs font-bold text-white hover:brightness-110">
              PROMPT
            </button>
        ...
        <div className="bg-surface border border-surface-border rounded-xl overflow-hidden flex flex-col hover:border-primary/40 transition-all group">
          <div className="p-6 flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="bg-text-secondary/10 text-text-secondary text-[10px] px-2 py-0.5 rounded-full font-bold border border-text-secondary/20">
                OSS
              </span>
            </div>
            <div className="space-y-3 pt-4 border-t border-surface-border">
        ...
        <div className="bg-surface border border-surface-border rounded-xl overflow-hidden flex flex-col hover:border-primary/40 transition-all group">
          <div className="p-6 flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="bg-purple-500/10 text-purple-500 text-[10px] px-2 py-0.5 rounded-full font-bold border border-purple-500/20">
                VIDEO
              </span>
            </div>
            <div className="space-y-3 pt-4 border-t border-surface-border">
